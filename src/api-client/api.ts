...
export type ProcessInstanceStateEnum =
...
export const JobsApiAxiosParamCreator = function (
  ...
  return {
    ...
    activateJobs: async (
      ...
      const localVarPath = `/jobs/{jobType}/activate`.replace(
        `{${"jobType"}}`,
        encodeURIComponent(String(jobType))
      );
...
export const JobsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.activateJobs(
        jobType,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["JobsApi.activateJobs"]?.[
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.completeJob(
        completeJobRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["JobsApi.completeJob"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const JobsApiFactory = function (
  ...
  return {
    ...
    completeJob(
      ...
      return localVarFp
        .completeJob(completeJobRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export const MessagesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async publishMessage(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.publishMessage(
        publishMessageRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["MessagesApi.publishMessage"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const MessagesApiFactory = function (
  ...
  return {
    ...
    publishMessage(
      ...
      return localVarFp
        .publishMessage(publishMessageRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
 ...
 * @export
 */
export const ProcessDefinitionsApiAxiosParamCreator = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    getProcessDefinition: async (
      ...
      const localVarPath =
        `/process-definitions/{processDefinitionKey}`.replace(
          `{${"processDefinitionKey"}}`,
          encodeURIComponent(String(processDefinitionKey))
        );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
 ...
 * @export
 */
export const ProcessDefinitionsApiFp = function (
  configuration?: Configuration
) {
  const localVarAxiosParamCreator =
    ProcessDefinitionsApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @summary Deploy a new process definition
    ...
    async createProcessDefinition(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<CreateProcessDefinition200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createProcessDefinition(body, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ProcessDefinitionsApi.createProcessDefinition"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getProcessDefinition(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ProcessDefinitionDetail>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getProcessDefinition(
          processDefinitionKey,
          options
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ProcessDefinitionsApi.getProcessDefinition"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getProcessDefinitions(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ProcessDefinitionsPage>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getProcessDefinitions(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ProcessDefinitionsApi.getProcessDefinitions"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const ProcessDefinitionsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
    ...
    createProcessDefinition(
      ...
      return localVarFp
        .createProcessDefinition(body, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getProcessDefinition(
      ...
      return localVarFp
        .getProcessDefinition(processDefinitionKey, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export class ProcessDefinitionsApi extends BaseAPI {
  ...
  public createProcessDefinition(
    ...
    return ProcessDefinitionsApiFp(this.configuration)
      .createProcessDefinition(body, options)
      .then((request) => request(this.axios, this.basePath));
  }
 ...
 * @export
 */
export const ProcessInstancesApiAxiosParamCreator = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    getActivities: async (
      ...
      const localVarPath =
        `/process-instances/{processInstanceKey}/activities`.replace(
          `{${"processInstanceKey"}}`,
          encodeURIComponent(String(processInstanceKey))
        );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
    ...
    getHistory: async (
      ...
      const localVarPath =
        `/process-instances/{processInstanceKey}/history`.replace(
          `{${"processInstanceKey"}}`,
          encodeURIComponent(String(processInstanceKey))
        );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getJobs: async (
      ...
      const localVarPath =
        `/process-instances/{processInstanceKey}/jobs`.replace(
          `{${"processInstanceKey"}}`,
          encodeURIComponent(String(processInstanceKey))
        );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getProcessInstance: async (
      ...
      const localVarPath = `/process-instances/{processInstanceKey}`.replace(
        `{${"processInstanceKey"}}`,
        encodeURIComponent(String(processInstanceKey))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const ProcessInstancesApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    ProcessInstancesApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @summary Create a new process instance
    ...
    async createProcessInstance(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ProcessInstance>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createProcessInstance(
          createProcessInstanceRequest,
          options
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ProcessInstancesApi.createProcessInstance"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getActivities(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ActivityPage>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ProcessInstancesApi.getActivities"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getHistory(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<FlowElementHistoryPage>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ProcessInstancesApi.getHistory"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getJobs(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<JobPage>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ProcessInstancesApi.getJobs"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getProcessInstance(
          processInstanceKey,
          options
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ProcessInstancesApi.getProcessInstance"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getProcessInstances(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ProcessInstancePage>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getProcessInstances(
          processDefinitionKey,
          page,
          size,
          options
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ProcessInstancesApi.getProcessInstances"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const ProcessInstancesApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
    ...
    createProcessInstance(
      ...
      return localVarFp
        .createProcessInstance(createProcessInstanceRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getActivities(
      processInstanceKey: string,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<ActivityPage> {
      return localVarFp
        .getActivities(processInstanceKey, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getHistory(
      ...
      return localVarFp
        .getHistory(processInstanceKey, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getJobs(
      processInstanceKey: string,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<JobPage> {
      return localVarFp
        .getJobs(processInstanceKey, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getProcessInstance(
      ...
      return localVarFp
        .getProcessInstance(processInstanceKey, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getProcessInstances(
      ...
      return localVarFp
        .getProcessInstances(processDefinitionKey, page, size, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class ProcessInstancesApi extends BaseAPI {
  ...
  public createProcessInstance(
    ...
    return ProcessInstancesApiFp(this.configuration)
      .createProcessInstance(createProcessInstanceRequest, options)
      .then((request) => request(this.axios, this.basePath));
  }
