...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BpmnEngineOpenApi.CreateProcessInstanceRequest();
  });
  ...
  describe('CreateProcessInstanceRequest', function() {
    it('should create an instance of CreateProcessInstanceRequest', function() {
      // uncomment below and update the code to test CreateProcessInstanceRequest
      //var instance = new BpmnEngineOpenApi.CreateProcessInstanceRequest();
      //expect(instance).to.be.a(BpmnEngineOpenApi.CreateProcessInstanceRequest);
    });
